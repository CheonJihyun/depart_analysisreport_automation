...
if __name__ == "__main__":
   ...
   # 1. 인스타그램 데이터 추출
    ...
    save_to_json(overall_bot_keyword_noun, "overall_top_keyword_noun.json")
    save_to_json(overall_bot_keyword_va, "overall_top_keyword_va.json")
    ...
    if main_age and main_gender:
        ...
        save_to_json(main_bot_keyword_noun, "main_top_keyword_noun.json")
        save_to_json(main_bot_keyword_va, "main_top_keyword_va.json")
    ...
    if avoid_age and avoid_gender:
        ...
        save_to_json(avoid_bot_keyword_noun, "avoid_top_keyword_noun.json")
        save_to_json(avoid_bot_keyword_va, "avoid_top_keyword_va.json")
